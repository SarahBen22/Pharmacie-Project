...
<div class="utiles">
  <div class="text_utiles">
    <strong>
      En pharmacie, vous pouvez avoir accès:
      <ul>
      <li>au dépistage du Diabète</li>
      <li>à l'aide à la prise de la tension</li>
      <li>à la vaccination contre la grippe</li>
      <li>à la mise à jour de la carte vitale via la borne</li>
      <li>à l'aide à la création de votre compte DMP (Dossier Médical Partagé)<br><a href="https://www.dmp.fr/" id="lien"> https://www.dmp.fr/</a></li>
      </ul>
    </strong>
  </div>
</div>
